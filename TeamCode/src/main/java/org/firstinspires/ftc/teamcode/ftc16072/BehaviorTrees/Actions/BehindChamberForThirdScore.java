...
public class BehindChamberForThirdScore extends QQTimeoutNode {
    public BehindChamberForThirdScore(double seconds) {
        super(seconds);
    }
    ...
    public State tick(DebugTree debug, QQOpMode opMode) {
        ...
        if (lastStatus != State.RUNNING){
            ...
            boolean isDoneDriving = opMode.nav.driveToPositionIN(17,-55,0);
        if (isDoneDriving) {
